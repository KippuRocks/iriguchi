...
export const SCREENS = {
  ...
  "operator.signin": { title: "Sign in", route: null, params: [] },
  "gate.choose": { title: "Choose a gate", route: null, params: [] },
  "gate.scan": { title: "Scan a pass", route: null, params: ["event", "gate"] },
