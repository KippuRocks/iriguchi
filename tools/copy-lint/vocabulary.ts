// The vocabulary Iriguchi's copy must never use: fee vocabulary (REQ-SP-1a) and trust
// claims (REQ-TM-2). The rules are Saifu's (T-030-11), reused
// unchanged so every native client refuses the same words.
//
