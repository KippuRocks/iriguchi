// Reads the screens and navigation declared in Iriguchi's sources (T-050-10;
// F-070 plan §5.4).
//
...
// and anything that moves between screens around the router — `Linking`, or a
// navigation library — so no transition escapes the manifest. No link opens
// Iriguchi, so nothing may read one.
