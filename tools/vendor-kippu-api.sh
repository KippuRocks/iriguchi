...
#
# Neither is published to any registry. @kippurocks/api is declarations only, and declares
# @trpc/server as a peer dependency, which this repository installs at the same version.
# @kippurocks/sponsorship declares @ticketto/sdk and @ticketto/profile-v0 as peer
